...
android_LogPriority glDebugSeverityToAndroidLogPriority(GLenum e) {
    switch (e) {
...
void KHRONOS_APIENTRY gl_debug_callback(GLenum source,
                                        GLenum type,
                                        GLuint id,
                                        GLenum severity,
                                        GLsizei /* length */,
    ...
    __android_log_print(glDebugSeverityToAndroidLogPriority(severity),
                        LOG_TAG,
                        "GL: %s: %s (id %d): %s",
